...
def wait_until_element_displayed(self, css_selector):
    WebDriverWait(self.driver, 20).until(expected_conditions.visibility_of_element_located(css_selector)).text

def wait_until_element_is_clickable(self, css_selector):
    WebDriverWait(self.driver, 20).until(expected_conditions.element_to_be_clickable(By.CSS_SELECTOR, css_selector))
